...
public interface ToaMistakeTrackerConfig extends Config {
    ...
    @ConfigSection(
            ...
            description = "Settings for the messages shown on Het puzzle and Akkha room mistakes.",
            position = 3,
    ...
    @ConfigSection(
            ...
            description = "Settings for the messages shown on Crondis puzzle and Zebak room mistakes.",
            position = 4,
            closedByDefault = true
    )
    ...
    @ConfigSection(
            ...
            description = "Settings for the messages shown on Kephri room mistakes.",
            position = 5,
            closedByDefault = true
    )
    ...
    @ConfigItem(
            ...
            description = "Message to show when letting a medic swarm reach the boss in the Kephri room.",
            section = kephriMistakeSettings,
            position = 1
    )
    ...
    @ConfigItem(
            ...
            description = "Message to show when hit by a hatching egg in the Kephri room.",
            section = kephriMistakeSettings,
            position = 2
    )
    ...
    @ConfigSection(
            ...
            description = "Settings for the messages shown on Apmeken puzzle and Ba-Ba room mistakes.",
            position = 6,
            closedByDefault = true
    )
    ...
    @ConfigSection(
            ...
            description = "Settings for the messages shown on Warden room mistakes.",
            position = 7,
            closedByDefault = true
    )
    ...
    @ConfigItem(
            ...
            name = "P3 Kephri",
            description = "Message to show when hit by a Kephri attack during Wardens P3.",
            section = wardensMistakeSettings,
            position = 7
    )
    ...
    @ConfigItem(
            ...
            name = "P3 Ba-Ba",
            description = "Message to show when hit by a Ba-Ba attack during Wardens P3.",
            section = wardensMistakeSettings,
            position = 8
    )
