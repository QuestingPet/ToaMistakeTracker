...
public enum ToaMistake {
    ...
    HET_PUZZLE_LIGHT("Het puzzle energy beam", "", "Ah! It burns!"),
    HET_PUZZLE_DARK_ORB("Het puzzle dark Orb", "", "Embrace Darkness!"),
    AKKHA_SPECIAL_QUADRANT_BOMB("Akkha quadrant bomb", "", "I'm too slow!"),
    AKKHA_SPECIAL_ELEMENTAL_ORBS("Akkha elemental orbs", "", "I'm griefing!"),
    AKKHA_UNSTABLE_ORB("Akkha unstable orb", "", "???"), // TODO: Increase
    CRONDIS_PUZZLE_LOW_WATER("Path of Crondis Low Watering", "",
            "I lost some water!"), // This jug feels a little light (?)
    ...
    BABA_BANANA("Ba-Ba banana", "", "Who put that there?"),
